          ...
          <div className="flex flex-col justify-between py-10 px-10   rounded-md shadow-lg w-[900px]">
            ...
            <div className="text-center mx-auto  w-[450px] rounded-md bg-[#5b40ff]">
              <p className="py-5 text-white">
                Dear [Student's Name], we want to support your <br /> success! Our
                analysis indicates a current predictive <br /> fail rate of 65%. Let's
                work together to explore <br /> strategies for improvement and ensure
                your <br /> continued progress.
              </p>
            </div>
          </div>
        </div>
